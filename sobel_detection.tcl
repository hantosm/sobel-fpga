...
#
# sobel_detection.tcl: Tcl script for re-creating project 'sobel_detection'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/vivado_project/sobel_detection.srcs/utils_1/imports/synth_1/hdmi_top.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "sobel_detection"
...
set script_file "sobel_detection.tcl"
...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xc7k70tfbg676-1 -quiet -force
...
set_property -name "webtalk.xsim_launch_sim" -value "191" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k70tfbg676-1 -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set obj [get_runs synth_1]
set_property -name "part" -value "xc7k70tfbg676-1" -objects $obj
set_property -name "incremental_checkpoint" -value "$proj_dir/sobel_detection.srcs/utils_1/imports/synth_1/hdmi_top.dcp" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k70tfbg676-1 -flow {Vivado Implementation 2021} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {

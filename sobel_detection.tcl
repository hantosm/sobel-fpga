...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xc7k325tfbg676-1 -quiet -force
...
set_property -name "part" -value "xc7k325tfbg676-1" -objects $obj
...
set obj [get_filesets constrs_1]
set_property -name "target_part" -value "xc7k325tfbg676-1" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k325tfbg676-1 -flow {Vivado Synthesis 2021} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k325tfbg676-1 -flow {Vivado Implementation 2021} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
